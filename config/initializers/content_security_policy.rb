...
Rails.application.config.content_security_policy do |policy|
  ...
  policy.frame_src 'https://yastatic.net', 'https://api-maps.yandex.ru/', 'https://mc.yandex.ru', 'https://money.yandex.ru', 'https://yoomoney.ru', 'https://yoomoney.ru/', 'https://*.yoomoney.ru', 'https://www.patreon.com', 'https://docs.google.com'
